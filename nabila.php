...
function get_CURL($url){
  ...
  $result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCmTnIeAicay58MQ4sQHzRUQ&key=AIzaSyCLsvVuBq0UUhMxz8Pa7v4P75HNuGd3wSw');
...
//   Video Terakhir
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyCLsvVuBq0UUhMxz8Pa7v4P75HNuGd3wSw&channelId=UCmTnIeAicay58MQ4sQHzRUQ&maxResult=1&order=date&part=snippet';
...
<body>
    ...
    <section class="jumbotron text-center">
        <img src="img/nabila.jpg" alt="Nabila Putri Renggah" width="125" class="rounded-circle img-thumbnail"
            data-aos="flip-right" data-aos-delay="500" data-aos-duration="1000" />
        <h1 class="display-4" data-aos="zoom-in-up" data-aos-duration="850">Nabila Putri Renggah</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="g-ytsubscribe" data-channelid="UCmTnIeAicay58MQ4sQHzRUQ" data-layout="default"
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="img/Instagram/fp_nabila.png" width="120" class="rounded-circle img-thumbnail">
                        </div>
                        <div class="col-md-8">
                            <h5>@nabilahrenggah</h5>
                            <p>1,564 Followers</p>
                        </div>
                    </div>
                    <div class="row mt-3 pb-3">
                        <!-- <div class="col">
                            <div class="ig-thumbnail">
                                <img src="img/Instagram/postingan icha/#" width="100">
                            </div>
                        </div>
                        <div class="col">
                            <div class="ig-thumbnail">
    ...
    <footer class="bg-warning text-center pb-3">
        <p>Created with <i class="bi bi-hearts text-danger"></i> by <a href="#" class="text-dark fw-bold">Nabila Putri
                Renggah</a>
        </p>
    </footer>
    <!-- Akhir Footer -->
