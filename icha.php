...
function get_CURL($url){
  ...
  $result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCck_RsHlV8zZxnlwuDSnVuA&key=AIzaSyCLsvVuBq0UUhMxz8Pa7v4P75HNuGd3wSw');
...
//   Video Terakhir
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyCLsvVuBq0UUhMxz8Pa7v4P75HNuGd3wSw&channelId=UCck_RsHlV8zZxnlwuDSnVuA&maxResult=1&order=date&part=snippet';
...
<body>
    ...
    <section class="jumbotron text-center">
        <img src="img/icah.jpg" alt="Andi Maha Izzah Ghazwani" width="125" class="rounded-circle img-thumbnail"
            data-aos="flip-right" data-aos-delay="500" data-aos-duration="1000" />
        <h1 class="display-4" data-aos="zoom-in-up" data-aos-duration="850">Andi Maha Izzah Ghazwani</h1>
    ...
    <section id="biodata">
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-right">
                ...
                <div class="col-md-4 mb-3" data-aos="fade-left" data-aos-duration="1000">
                    <p>BTN Korpri Kawatuna Blok C2 No.43</p>
                </div>
            </div>
            <div class="row justify-content-center fs-5 text-right">
                <div class="col-md-2 mb-3" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="g-ytsubscribe" data-channelid="UCck_RsHlV8zZxnlwuDSnVuA" data-layout="default"
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="img/Instagram/fp_icha.jpg" width="120" class="rounded-circle img-thumbnail">
                        </div>
                        <div class="col-md-8">
                            <h5>@ichakyle</h5>
                            <p>4,442 Followers</p>
                    ...
                    <div class="row mt-3 pb-3">
                        <div class="col">
                            <div class="ig-thumbnail">
                                <img src="img/Instagram/postingan icha/1.jpeg" width="100">
                            </div>
                        </div>
                        <div class="col">
                            <div class="ig-thumbnail">
                                <img src="img/Instagram/postingan icha/2.jpeg" width="100">
                            </div>
                        </div>
                        <div class="col">
                            <div class="ig-thumbnail">
                                <img src="img/Instagram/postingan icha/3.jpeg" width="100">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-warning text-center pb-3">
        <p>Created with <i class="bi bi-hearts text-danger"></i> by <a href="#" class="text-dark fw-bold">Andi Maha
                Izzah Ghazwani</a>
        </p>
    </footer>
    <!-- Akhir Footer -->
